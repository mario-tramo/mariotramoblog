...
const securityHeaders = [
	...
	},
	{
		...
		value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.sanity.io https://platform.twitter.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https://cdn.sanity.io https://avatars.githubusercontent.com https://picsum.photos https://pbs.twimg.com; font-src 'self'; connect-src 'self' https://cdn.sanity.io https://*.api.sanity.io https://api.football-data.org https://*.upstash.io https://platform.twitter.com; frame-src 'self' https://www.youtube.com https://twitter.com https://x.com https://platform.twitter.com https://www.instagram.com https://www.tiktok.com https://www.facebook.com https://www.threads.net; media-src 'self' https://cdn.sanity.io;",
	},
]
